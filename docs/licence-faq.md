...
**Yes.** Running it to send your own/your company's mail is fine, including on internal servers and for
commercial business activity. Sending mail through Dispatch is *using* the software, not *selling* it.

### Can I modify the source?
**Yes.** Modify it freely. Under the AGPL, if you run a modified version as a network service for others,
...
General consulting/integration work is typically fine; **charging for hosting/support of Dispatch itself**
is what the Commons Clause restricts. If in doubt, ask.
