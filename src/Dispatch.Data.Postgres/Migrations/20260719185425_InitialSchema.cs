        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    scope = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false, defaultValue: "send")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    name = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    recipient_pattern = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    from_address = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                    from_domain = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    to_addresses = table.Column<string>(type: "text", nullable: false),
                    to_domain = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    ...
                    relay_name = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    routing_rule_id = table.Column<int>(type: "integer", nullable: true),
                    routing_rule_name = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    routing_matched = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    ...
                    ingest_source = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false, defaultValue: "SMTP"),
                    source_ip = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    api_key_id = table.Column<int>(type: "integer", nullable: true),
                    api_key_name = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    tags = table.Column<string>(type: "text", nullable: true),
                    x_mailer = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                ...
                descending: new[] { false, true })
                .Annotation("Npgsql:IndexInclude", new[] { "status", "event", "spool_id", "from_address", "to_domain", "subject", "provider", "duration_ms" });
            ...
            migrationBuilder.CreateIndex(
                ...
                descending: new[] { false, true })
                .Annotation("Npgsql:IndexInclude", new[] { "spool_id", "from_address", "from_domain", "to_domain", "subject", "size_bytes", "relay_name", "routing_rule_name", "provider", "duration_ms", "ingest_source", "retry_attempt" });
